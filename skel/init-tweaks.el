...
(with-eval-after-load 'me-lib
  ...
  ;; this will creates the hooks `ematrix-first-c/c++-file-hook' and and
  ;; `ematrix-first-python-file-hook' that will provide the features
  ;; `ematrix-first-c/c++-file' and `ematrix-first-python-file'.
